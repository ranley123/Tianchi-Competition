...
class FullyConnected(nn.Module):
    def __init__(self):
        ...
        self.hidden2 = nn.Linear(512,128).double()
...
def make_Xvector_model(num_spk):
    context = [-2,2]
    input_dim = 23
    output_dim = 512
    ...
    SP = StatsPooling()
    FC = FullyConnected()
    Final = nn.Linear(128,num_spk+1).double()
    model = nn.Sequential(net1,net2,net3,net4,net5,SP,FC,Final)
    return model